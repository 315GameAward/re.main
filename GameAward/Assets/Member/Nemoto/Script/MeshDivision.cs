...
public class MeshDivision : MonoBehaviour
{
    ...
    public void DivisionMesh(List<Vector3> cutPoint)
    {
        ...
        GameObject obj = new GameObject("Plane", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshDivision));
        var mesh = new Mesh();
